...
public class UserRegistrationPage extends LayoutWebPage {
	private static final long serialVersionUID = 1L;

	@Override
	protected Panel getContentPanel(String id, PageParameters pageParameters) {
		return new RegistrationPanel<RegistrationModel, User>(id, new Model<RegistrationModel>(new RegistrationModel()));
	}
