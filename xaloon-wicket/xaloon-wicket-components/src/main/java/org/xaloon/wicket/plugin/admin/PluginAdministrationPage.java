...
@MountPage(value = "/plugin-management/${" + CategoryConstants.PAGE_NAMED_PARAMETER_PARENT_CATEGORY + "}", order = 10, visible = false)
public class PluginAdministrationPage extends AdministrationGroupPage {
