 ...
 * @author vytautas r.
 */
public class GenerateNewPasswordEmailTemplatePage extends EmailContentTemplatePage {
	/**
	 * 
	 */
	 ...
	 * @param password
	 */
	public GenerateNewPasswordEmailTemplatePage(String username, String password) {
