 ...
 * @author vytautas r.
 */
public class InappropriateFlagEmailTemplatePage extends EmailContentTemplatePage {
	 ...
	 * @param messageText
	 */
	public InappropriateFlagEmailTemplatePage(String originalUrl, String displayName, String messageText) {
