 ...
 * @author vytautas r.
 */
public class InappropriateCommentsForApprovalPanel extends AbstractPluginPanel<CommentPluginBean, CommentPlugin> {
	 ...
	 */
	public InappropriateCommentsForApprovalPanel(String id, PageParameters pageRequestParameters) {
