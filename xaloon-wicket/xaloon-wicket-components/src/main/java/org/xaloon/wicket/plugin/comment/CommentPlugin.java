 ...
 */
package org.xaloon.wicket.plugin.comment;
...
import org.xaloon.wicket.plugin.comment.panel.CommentAdministrationPanel;

/**
 * @author vytautas r.
 */
@Named
public class CommentPlugin extends AbstractPlugin<CommentPluginBean> {
	...
	public Class<?> getAdministratorFormClass() {
		return CommentAdministrationPanel.class;
	}
}
