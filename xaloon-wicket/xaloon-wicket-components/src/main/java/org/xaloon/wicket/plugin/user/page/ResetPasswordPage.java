...
import org.xaloon.wicket.plugin.user.panel.GenerateNewPasswordPanel;

/**
 * @author vytautas r.
 */
@MountPage(value = "/reset-password", order = 20, visible = false)
public class ResetPasswordPage extends LayoutWebPage {
	private static final long serialVersionUID = 1L;

	@Override
	protected Panel getContentPanel(String id, PageParameters pageParameters) {
		return new GenerateNewPasswordPanel(id);
	}
}
