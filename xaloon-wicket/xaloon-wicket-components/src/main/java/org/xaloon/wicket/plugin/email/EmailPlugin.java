...
import org.xaloon.wicket.plugin.email.panel.EmailAdministrationPanel;

/**
 * @author vytautas r.
 */
@Named
public class EmailPlugin extends AbstractPlugin<EmailPluginBean> {
	 ...
	 */
	public EmailPlugin() {
		setCategory(DefaultPluginCategories.COMMUNICATION);
	}

	@Override
	public Class<?> getAdministratorFormClass() {
		return EmailAdministrationPanel.class;
	}
}
