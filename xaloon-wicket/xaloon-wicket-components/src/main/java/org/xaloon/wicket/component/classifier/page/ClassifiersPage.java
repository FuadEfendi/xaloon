 ...
 * @author vytautas r.
 */
@MountPage(value = "/classifiers-management", order = 20)
public class ClassifiersPage extends AdministrationGroupPage {
	...
	protected Panel getContentPanel(String id, PageParameters pageParameters) {
		return new ClassifiersPanel(id, pageParameters);
	}
}
