...
import org.xaloon.wicket.plugin.user.admin.panel.RolesPanel;

/**
 * @author vytautas r.
 */
@MountPage(value = "/roles", order = 30)
public class RolesPage extends SecurityGroupPage {
	...
	protected Panel getContentPanel(String id, PageParameters pageParameters) {
		return new RolesPanel(id, pageParameters);
	}
