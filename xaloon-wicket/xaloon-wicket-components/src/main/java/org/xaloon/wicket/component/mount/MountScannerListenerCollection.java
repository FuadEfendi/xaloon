 ...
 * @author vytautas r.
 */
public class MountScannerListenerCollection extends ListenerCollection<MountScannerListener> implements MountScannerListener {
	...
	public void onMount(final List<Class<?>> classesToMount) {
