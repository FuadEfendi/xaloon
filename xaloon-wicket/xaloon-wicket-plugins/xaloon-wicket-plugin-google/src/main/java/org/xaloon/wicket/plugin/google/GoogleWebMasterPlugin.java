...
import org.xaloon.wicket.plugin.google.panel.GoogleWebMasterAdministrationPanel;
 ...
 */
@Named
public class GoogleWebMasterPlugin extends AbstractPlugin<KeyValuePluginBean> {
	...
	public Class<?> getAdministratorFormClass() {
		return GoogleWebMasterAdministrationPanel.class;
	}
}
