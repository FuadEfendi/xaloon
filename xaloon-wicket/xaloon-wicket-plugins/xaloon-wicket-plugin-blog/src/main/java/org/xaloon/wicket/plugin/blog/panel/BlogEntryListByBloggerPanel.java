 ...
 * @author vytautas r.
 */
public class BlogEntryListByBloggerPanel extends BlogEntryListPanel {
	 ...
	 */
	public BlogEntryListByBloggerPanel(String id, PageParameters pageParameters) {
	...
	private class JpaBlogEntryDataByBloggerProvider implements IDataProvider<BlogEntry> {
		...
		public JpaBlogEntryDataByBloggerProvider(String keyValue) {
			blogEntrySearchRequest.setUsername(keyValue);
		}
